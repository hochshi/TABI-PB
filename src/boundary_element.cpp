                                     ...
                                     bool device_ptrs)
{
    ...
    if (device_ptrs) {
        void* stream = nullptr;
        BoundaryElement::matrix_vector_cuda(alpha, potential_old, beta, potential_new, stream);
        return;
    }
#endif

    BoundaryElement::matrix_vector_cpu_(alpha, potential_old, beta, potential_new);
}
